...
const TermsCondition = () => {
  return (
    <main className='pt-[88px]  w-full text-black'>
      <div className='container mx-auto py-[60px] space-y-[40px]'>
        <GradientHeading>Terms & Conditions </GradientHeading>
        <p className='text-[24px] font-[300] text-center'>
        ...
        <TermsScreen TERMS_SECTIONS={TERMS_SECTIONS} />
      </div>
    </main>
  );
};
